      ...
      <div className="m-5">
        <div className="flex flex-col w-full max-w-[1124px] items-start gap-6 relative">
          ...
          <div className="flex w-full items-center gap-4 relative">
            <h2 className="font-['HK_Grotesk-Medium',Helvetica] font-medium text-black text-xl tracking-[0] leading-normal whitespace-nowrap">
              Analytics
            </h2>
          ...
          <footer className="flex items-center justify-center gap-2.5 relative w-full">
            <p className="font-['HK_Grotesk-SemiBold',Helvetica] font-semibold text-[#6B7280] text-sm tracking-[0] leading-normal text-center">
              Powered by Base · Daonergy Labs © 2025 – All Rights Reserved.
            </p>
          </footer>
        </div>
      </div>
